<template lang="pug">
  .page
    ...
    .btn-div
      div
        el-button(icon="el-icon-plus" @click="addPartner") 新增成员
        el-button(icon="el-icon-minus") 删除成员
        el-button(icon="el-icon-s-tools") 设为管理员
        el-button(icon="el-icon-s-tools") 设为普通成员
    .table-div
